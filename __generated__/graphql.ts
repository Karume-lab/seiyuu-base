...
export type GetActorInfoQueryVariables = Exact<{
  name?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetActorInfoQuery = { __typename?: 'Query', Staff?: { __typename?: 'Staff', name?: { __typename?: 'StaffName', full?: string | null } | null, image?: { __typename?: 'StaffImage', large?: string | null } | null, characterMedia?: { __typename?: 'MediaConnection', edges?: Array<{ __typename?: 'MediaEdge', node?: { __typename?: 'Media', title?: { __typename?: 'MediaTitle', romaji?: string | null, english?: string | null } | null, coverImage?: { __typename?: 'MediaCoverImage', medium?: string | null } | null } | null, characters?: Array<{ __typename?: 'Character', name?: { __typename?: 'CharacterName', full?: string | null } | null, image?: { __typename?: 'CharacterImage', medium?: string | null } | null } | null> | null } | null> | null } | null } | null };



export const GetActorInfoDocument = /*#__PURE__*/ `
    query GetActorInfo($name: String) {
  Staff(search: $name) {
    name {
      full
    }
...
export const useGetActorInfoQuery = <
      TData = GetActorInfoQuery,
      TError = unknown
    >(
      variables?: GetActorInfoQueryVariables,
      options?: Omit<UseQueryOptions<GetActorInfoQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetActorInfoQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetActorInfoQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['GetActorInfo'] : ['GetActorInfo', variables],
    queryFn: fetcher<GetActorInfoQuery, GetActorInfoQueryVariables>(GetActorInfoDocument, variables),
    ...options
  }
    )};

useGetActorInfoQuery.getKey = (variables?: GetActorInfoQueryVariables) => variables === undefined ? ['GetActorInfo'] : ['GetActorInfo', variables];

export const useInfiniteGetActorInfoQuery = <
      TData = InfiniteData<GetActorInfoQuery>,
      TError = unknown
    >(
      variables: GetActorInfoQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetActorInfoQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetActorInfoQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetActorInfoQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? variables === undefined ? ['GetActorInfo.infinite'] : ['GetActorInfo.infinite', variables],
      queryFn: (metaData) => fetcher<GetActorInfoQuery, GetActorInfoQueryVariables>(GetActorInfoDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetActorInfoQuery.getKey = (variables?: GetActorInfoQueryVariables) => variables === undefined ? ['GetActorInfo.infinite'] : ['GetActorInfo.infinite', variables];
